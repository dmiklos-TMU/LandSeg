...
# This code has been modified to only use Dice Loss and Tversky
class TotalLoss(nn.Module):
    ...
    def __init__(self):
        ...
        self.seg_dice = TverskyLoss(mode="multiclass", alpha=0.5, beta=0.5, gamma=4.0/3, from_logits=True)
    ...
    def forward(self, outputs, targets):
        ...
        _,seg_LS= torch.max(seg_LS, 1)
        seg_LS=seg_LS.cuda()

        dice_loss = self.seg_dice(out_LS, seg_LS)
        focal_loss = self.seg_focal(out_LS, seg_LS)
